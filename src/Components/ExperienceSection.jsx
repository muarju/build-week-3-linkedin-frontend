    ...
    return (
      <div>
        <Card.Body>
          ...
          {experiences && sliceValue.map(exp => <Experience onUpdate={props.onUpdate} key={exp._id} experienceData={exp} username={username} params={props.params} fetch={fetchExperiences}/> )}
