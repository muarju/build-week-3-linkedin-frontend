...
export default function FeedSidebarFooter(props) {
	...
	return (
           ...
           <div className={`${scrolled ? 'sidebar-sticky-footer' : ''} d-none d-lg-block`}>
