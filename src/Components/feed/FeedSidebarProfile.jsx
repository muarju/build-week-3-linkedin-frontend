	...
	return (
  	<Card className="mt-2">
            ...
            <Card.Body className="leftSidebarCardBody">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" style={{marginTop:"-16px", height:"16px"}} viewBox="0 0 24 24" data-supported-dps="24x24" className="mercado-match" width="24" height="24" focusable="false">
